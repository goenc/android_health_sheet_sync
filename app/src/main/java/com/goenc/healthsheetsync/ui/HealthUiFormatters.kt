...
internal const val WAIST_CHART_MAX_CM = 160.0
internal const val WAIST_CHART_DISPLAY_MIN_CM = 75.0
internal const val WAIST_CHART_DISPLAY_MAX_CM = 95.0
internal const val WAIST_CHART_REFERENCE_CM = 85.0
internal const val WAIST_CHART_DISPLAY_BAND_MIN_CM = 70.0
internal const val WAIST_CHART_DISPLAY_BAND_MAX_CM = 100.0
...
internal val WAIST_CHART_LINES_CM = listOf(WAIST_CHART_DISPLAY_MIN_CM, WAIST_CHART_REFERENCE_CM)
